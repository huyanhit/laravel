...
<html lang="en">
	<head>
	    ...
	    <link rel="stylesheet" id="carousel-css" href="./resources/assets/css/owl.carousel.css" type="text/css">
	    <link rel="stylesheet" id="style-css" href="./resources/assets/css/flexslider.css" type="text/css" media="all">
